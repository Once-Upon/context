...
import { detectLeeroy, generateLeeroyContext } from './leeroy';
import leeroy0x9c6d7a1a from '../../test/transactions/leeroy-0x9c6d7a1a.json';
import catchall0xc35c01ac from '../../test/transactions/catchall-0xc35c01ac.json';

describe('Leeroy', () => {
  it('Should detect leeroy', () => {
    const leeroy1 = detectLeeroy(leeroy0x9c6d7a1a as Transaction);
    expect(leeroy1).toBe(true);
  });

  it('Should generate leeroy context', () => {
    const leeroy1 = generateLeeroyContext(leeroy0x9c6d7a1a as Transaction);
  ...
  it('Should not detect as leeroy', () => {
    const leeroy1 = detectLeeroy(catchall0xc35c01ac as Transaction);
