...
describe('Token Approval', () => {
  ...
  it('Should not detect token approval transaction', () => {
    const tokenApproval1 = detect(catchall0xc35c01ac as unknown as Transaction);
