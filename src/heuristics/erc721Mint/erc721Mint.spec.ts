...
describe('ERC721 Mint', () => {
  ...
  it('Should generate a context for token mint', () => {
    ...
    const erc721MintContext1 = erc721Mint1.context || {};
    expect(erc721MintContext1.summaries?.category).toBe('NFT');
    const desc1 = contextSummary(erc721MintContext1);
    expect(desc1).toBe(
    ...
    const erc721MintContext2 = erc721Mint2.context || {};
    expect(erc721MintContext2.summaries?.category).toBe('NFT');
    const desc2 = contextSummary(erc721MintContext2);
    expect(desc2).toBe(
