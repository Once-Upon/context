...
describe('transactionAssetTransfers', () => {
  it('should return asset transfers for eth transactions', () => {
    ...
    // testing deposit in tx: https://www.onceupon.xyz/0x020b4772754a0caf0512c43da6275d6f8c9000f3915850639f799a254d70bccb
    ...
    // testing withdrawal in tx: https://www.onceupon.xyz/0x2496fa85b6046f44b0ae0ee6315db0757cad9f7c0c9fdb17a807169937bc3870
  ...
  it('should return asset transfers for erc20 transactions', () => {
    // Self destructed contract refunds in tx: https://www.onceupon.xyz/0x7899aabe7417de87d1c4c28c320d7c6781021cee2b11bfb81440132d4413ee87
