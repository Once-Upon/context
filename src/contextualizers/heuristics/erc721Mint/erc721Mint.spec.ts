...
describe('ERC721 Mint', () => {
  it('Should detect ERC721 Mint transaction', () => {
    const erc721Mint1 = detect(erc721Mint0x2c8a3ed1 as unknown as Transaction);
    expect(erc721Mint1).toBe(true);

    const erc721Mint2 = detect(erc721Mint0x35f54999 as unknown as Transaction);
  ...
  it('Should not detect as ERC721 Mint', () => {
    const isErc721Mint1 = detect(erc20Swap0xd55dc9b2 as unknown as Transaction);
